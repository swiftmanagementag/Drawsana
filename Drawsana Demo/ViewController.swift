...
class ViewController: UIViewController {
    ...
    @objc private func viewFinalImage(_: Any?) {
    ...
    @objc private func cycleStrokeWidth(_: Any?) {
...
extension ViewController: ColorPickerViewControllerDelegate {
    func colorPickerViewControllerDidPick(colorIndex _: Int, color: UIColor?, identifier: String) {
        switch identifier {
        case "stroke":
...
extension ViewController: DrawsanaViewDelegate {
    ...
    func drawsanaView(_: DrawsanaView, didSwitchTo _: DrawingTool) {
        toolButton.setTitle(drawingView.tool?.name ?? "", for: .normal)
    }

    func drawsanaView(_: DrawsanaView, didChangeStrokeColor _: UIColor?) {
    ...
    func drawsanaView(_: DrawsanaView, didChangeFillColor _: UIColor?) {
    ...
    func drawsanaView(_: DrawsanaView, didChangeStrokeWidth _: CGFloat) {
    ...
    func drawsanaView(_: DrawsanaView, didChangeFontName _: String) {}

    func drawsanaView(_: DrawsanaView, didChangeFontSize _: CGFloat) {}

    func drawsanaView(_: DrawsanaView, didStartDragWith _: DrawingTool) {}

    func drawsanaView(_: DrawsanaView, didEndDragWith _: DrawingTool) {}
}
...
extension ViewController: TextToolDelegate {
    ...
    func textToolDidTapAway(tappedPoint _: CGPoint) {
...
extension ViewController: DrawingOperationStackDelegate {
    func drawingOperationStackDidUndo(_: DrawingOperationStack, operation _: DrawingOperation) {
        applyUndoViewState()
    }

    func drawingOperationStackDidRedo(_: DrawingOperationStack, operation _: DrawingOperation) {
        applyUndoViewState()
    }

    func drawingOperationStackDidApply(_: DrawingOperationStack, operation _: DrawingOperation) {
        applyUndoViewState()
    }
}
