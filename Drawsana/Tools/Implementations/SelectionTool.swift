...
public class SelectionTool: DrawingTool {
    ...
    public func handleDragContinue(context: ToolOperationContext, point: CGPoint, velocity _: CGPoint) {
        guard
            isDraggingShape,
    ...
    public func handleDragCancel(context: ToolOperationContext, point _: CGPoint) {
