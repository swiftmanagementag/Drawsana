...
public class PenTool: DrawingTool {
    ...
    public func handleDragStart(context: ToolOperationContext, point: CGPoint) {
        ...
        context.userSettings.strokeColor?.getWhite(&white, alpha: &alpha)
        lastVelocity = .zero
        let shape = PenShape()
    ...
    public func handleDragContinue(context _: ToolOperationContext, point: CGPoint, velocity: CGPoint) {
    ...
    public func handleDragEnd(context: ToolOperationContext, point _: CGPoint) {
    ...
    public func renderShapeInProgress(transientContext _: CGContext) {
...
public class EraserTool: PenTool {
    override public var name: String { return "Eraser" }
    override public var isProgressive: Bool { return true }
    override public init() {
        super.init()
        velocityBasedWidth = false
    }

    override public func handleTap(context: ToolOperationContext, point: CGPoint) {
    ...
    override public func renderShapeInProgress(transientContext: CGContext) {
