...
public extension DrawingTool {
    func activate(shapeUpdater _: DrawsanaViewShapeUpdating, context _: ToolOperationContext, shape _: Shape?) {}
    func deactivate(context _: ToolOperationContext) {}
    func apply(context _: ToolOperationContext, userSettings _: UserSettings) {}
    func renderShapeInProgress(transientContext _: CGContext) {}
}
